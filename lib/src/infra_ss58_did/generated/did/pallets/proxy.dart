...
import '../types/did_runtime/proxy_type.dart' as _i11;
...
class Constants {
  ...
  final BigInt proxyDepositBase = BigInt.from(2004000000);
  ...
  final BigInt proxyDepositFactor = BigInt.from(3300000);
  ...
  /// bytes).
  final BigInt announcementDepositBase = BigInt.from(2004800000);

  /// The amount of currency needed per announcement made.
  ///
  /// This is held for adding an `AccountId`, `Hash` and `BlockNumber` (typically 68 bytes)
  /// into a pre-existing storage value.
  final BigInt announcementDepositFactor = BigInt.from(6600000);
}
