...
class BBSPlusParameters {
  const BBSPlusParameters({
    this.label,
    required this.curveType,
    required this.bytes,
  });

  factory BBSPlusParameters.decode(_i1.Input input) {
  ...
  static const $BBSPlusParametersCodec codec = $BBSPlusParametersCodec();
...
class $BBSPlusParametersCodec with _i1.Codec<BBSPlusParameters> {
  const $BBSPlusParametersCodec();

  @override
  void encodeTo(
    BBSPlusParameters obj,
    _i1.Output output,
  ) {
  ...
  @override
  BBSPlusParameters decode(_i1.Input input) {
    return BBSPlusParameters(
  ...
  @override
  int sizeHint(BBSPlusParameters obj) {
    int size = 0;
    size = size +
