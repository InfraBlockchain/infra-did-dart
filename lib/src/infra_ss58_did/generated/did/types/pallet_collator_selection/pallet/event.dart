...
class $Event {
  ...
  NewInvulnerables newInvulnerables(
  ...
  InvulnerableRemoved invulnerableRemoved(
  ...
  InvalidInvulnerableSkipped invalidInvulnerableSkipped(
      {required _i3.AccountId32 accountId}) {
...
class NewDesiredCandidates extends Event {
  ...
  factory NewDesiredCandidates._decode(_i1.Input input) {
    return NewDesiredCandidates(
        desiredCandidates: _i1.U32Codec.codec.decode(input));
  }
  ...
  bool operator ==(Object other) =>
      ...
      other is NewDesiredCandidates &&
          other.desiredCandidates == desiredCandidates;
...
class InvalidInvulnerableSkipped extends Event {
  ...
  factory InvalidInvulnerableSkipped._decode(_i1.Input input) {
    return InvalidInvulnerableSkipped(
        accountId: const _i1.U8ArrayCodec(32).decode(input));
  }
