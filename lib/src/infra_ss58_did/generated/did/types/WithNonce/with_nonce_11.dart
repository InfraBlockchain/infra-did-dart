...
import '../OnChainDidDetails/on_chain_did_details.dart' as _i2;
...
class WithNonce {
  ...
  /// D
  final _i2.OnChainDidDetails data;
...
class $WithNonceCodec with _i1.Codec<WithNonce> {
  ...
  void encodeTo(
    ...
    _i2.OnChainDidDetails.codec.encodeTo(
      obj.data,
      output,
    );
  }
  ...
  WithNonce decode(_i1.Input input) {
    return WithNonce(
      ...
      data: _i2.OnChainDidDetails.codec.decode(input),
    );
  }
  ...
  int sizeHint(WithNonce obj) {
    ...
    size = size + _i2.OnChainDidDetails.codec.sizeHint(obj.data);
    return size;
  }
}
