...
class WithNonce {
  ...
  /// D
  final _i2.RemoveStatusListCredentialRaw data;
...
class $WithNonceCodec with _i1.Codec<WithNonce> {
  ...
  void encodeTo(
    ...
    _i2.RemoveStatusListCredentialRaw.codec.encodeTo(
      obj.data,
      output,
    );
  }
  ...
  WithNonce decode(_i1.Input input) {
    return WithNonce(
      ...
      data: _i2.RemoveStatusListCredentialRaw.codec.decode(input),
    );
  }
  ...
  int sizeHint(WithNonce obj) {
    ...
    size = size + _i2.RemoveStatusListCredentialRaw.codec.sizeHint(obj.data);
    return size;
  }
}
