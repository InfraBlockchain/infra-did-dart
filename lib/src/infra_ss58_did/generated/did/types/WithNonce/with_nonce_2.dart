...
import '../UnRevokeRaw/un_revoke_raw.dart' as _i2;
...
class $WithNonceCodec with _i1.Codec<WithNonce> {
  ...
  void encodeTo(
    ...
    _i2.UnRevokeRaw.codec.encodeTo(
      obj.data,
      output,
    );
  }
  ...
  WithNonce decode(_i1.Input input) {
    return WithNonce(
      ...
      data: _i2.UnRevokeRaw.codec.decode(input),
    );
  }
  ...
  int sizeHint(WithNonce obj) {
    ...
    size = size + _i2.UnRevokeRaw.codec.sizeHint(obj.data);
    return size;
  }
}
