...
import '../RemoveVerifierRaw/remove_verifier_raw.dart' as _i2;
...
class WithNonce {
  ...
  /// D
  final _i2.RemoveVerifierRaw data;
...
class $WithNonceCodec with _i1.Codec<WithNonce> {
  ...
  void encodeTo(
    ...
    _i2.RemoveVerifierRaw.codec.encodeTo(
      obj.data,
      output,
    );
  }
  ...
  WithNonce decode(_i1.Input input) {
    return WithNonce(
      ...
      data: _i2.RemoveVerifierRaw.codec.decode(input),
    );
  }
  ...
  int sizeHint(WithNonce obj) {
    ...
    size = size + _i2.RemoveVerifierRaw.codec.sizeHint(obj.data);
    return size;
  }
}
