...
import '../RemoveAuthorizerRaw/remove_authorizer_raw.dart' as _i2;
...
class WithNonce {
  ...
  /// D
  final _i2.RemoveAuthorizerRaw data;
...
class $WithNonceCodec with _i1.Codec<WithNonce> {
  ...
  void encodeTo(
    ...
    _i2.RemoveAuthorizerRaw.codec.encodeTo(
      obj.data,
      output,
    );
  }
  ...
  WithNonce decode(_i1.Input input) {
    return WithNonce(
      ...
      data: _i2.RemoveAuthorizerRaw.codec.decode(input),
    );
  }
  ...
  int sizeHint(WithNonce obj) {
    ...
    size = size + _i2.RemoveAuthorizerRaw.codec.sizeHint(obj.data);
    return size;
  }
}
