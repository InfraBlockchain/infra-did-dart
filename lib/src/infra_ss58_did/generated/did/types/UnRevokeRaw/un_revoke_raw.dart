...
class UnRevokeRaw {
  ...
  factory UnRevokeRaw.decode(_i1.Input input) {
  ...
  static const $UnRevokeRawCodec codec = $UnRevokeRawCodec();
...
class $UnRevokeRawCodec with _i1.Codec<UnRevokeRaw> {
  const $UnRevokeRawCodec();
  ...
  @override
  UnRevokeRaw decode(_i1.Input input) {
    return UnRevokeRaw(
