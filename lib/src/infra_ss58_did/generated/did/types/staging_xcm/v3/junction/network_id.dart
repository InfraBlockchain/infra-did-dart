  ...
  void encodeTo(
    ...
    switch (value.runtimeType) {
      ...
      case ByFork:
        ...
        break;
      case InfraRelay:
        (value as InfraRelay).encodeTo(output);
        break;
      case Polkadot:
...
class InfraRelay extends NetworkId {
  const InfraRelay();

  @override
  Map<String, dynamic> toJson() => {'InfraRelay': null};
  ...
  @override
  bool operator ==(Object other) => other is InfraRelay;
