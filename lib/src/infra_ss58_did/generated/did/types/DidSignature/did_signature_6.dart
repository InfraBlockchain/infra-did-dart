...
import '../SignatureParamsOwner/signature_params_owner.dart' as _i2;
...
class DidSignature {
  ...
  /// D
  final _i2.SignatureParamsOwner did;
...
class $DidSignatureCodec with _i1.Codec<DidSignature> {
  ...
  int sizeHint(DidSignature obj) {
    int size = 0;
    size = size + const _i2.SignatureParamsOwnerCodec().sizeHint(obj.did);
