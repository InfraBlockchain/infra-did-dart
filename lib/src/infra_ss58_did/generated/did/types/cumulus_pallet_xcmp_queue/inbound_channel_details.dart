...
import '../parachain_primitives/primitives/id.dart' as _i2;
import '../parachain_primitives/primitives/xcmp_message_format.dart' as _i5;
...
class InboundChannelDetails {
  ...
  static const $InboundChannelDetailsCodec codec =
      $InboundChannelDetailsCodec();
...
class $InboundChannelDetailsCodec with _i1.Codec<InboundChannelDetails> {
  ...
  void encodeTo(
    ...
    const _i1.SequenceCodec<_i4.Tuple2<int, _i5.XcmpMessageFormat>>(
        _i4.Tuple2Codec<int, _i5.XcmpMessageFormat>(
      _i1.U32Codec.codec,
