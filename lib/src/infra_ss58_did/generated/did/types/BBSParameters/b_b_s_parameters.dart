...
class BBSParameters {
  ...
  factory BBSParameters.decode(_i1.Input input) {
  ...
  static const $BBSParametersCodec codec = $BBSParametersCodec();
...
class $BBSParametersCodec with _i1.Codec<BBSParameters> {
  const $BBSParametersCodec();
  ...
  @override
  BBSParameters decode(_i1.Input input) {
  ...
  @override
  int sizeHint(BBSParameters obj) {
    int size = 0;
    size = size +
