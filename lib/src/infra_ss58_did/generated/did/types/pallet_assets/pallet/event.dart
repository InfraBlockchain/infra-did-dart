...
class $Event {
  ...
  Demoted demoted({required int assetId}) {
    return Demoted(assetId: assetId);
  }

  AssetSystemTokenWeightChanged assetSystemTokenWeightChanged({
    required int assetId,
    required BigInt from,
    required BigInt to,
  }) {
    return AssetSystemTokenWeightChanged(
      assetId: assetId,
      from: from,
      to: to,
    );
...
class $EventCodec with _i1.Codec<Event> {
  ...
  Event decode(_i1.Input input) {
    ...
    switch (index) {
      ...
      case 24:
        return Promoted._decode(input);
      case 25:
        return Demoted._decode(input);
      case 26:
        return AssetSystemTokenWeightChanged._decode(input);
      default:
  ...
  void encodeTo(
    ...
    switch (value.runtimeType) {
      ...
      case Blocked:
        ...
        break;
      case Promoted:
        (value as Promoted).encodeTo(output);
        break;
      case Demoted:
        (value as Demoted).encodeTo(output);
        break;
      case AssetSystemTokenWeightChanged:
        (value as AssetSystemTokenWeightChanged).encodeTo(output);
        break;
      default:
        throw Exception(
  ...
  int sizeHint(Event value) {
    switch (value.runtimeType) {
      ...
      case Promoted:
        return (value as Promoted)._sizeHint();
      case Demoted:
        return (value as Demoted)._sizeHint();
      case AssetSystemTokenWeightChanged:
        return (value as AssetSystemTokenWeightChanged)._sizeHint();
      default:
        throw Exception(
            'Event: Unsupported "$value" of type "${value.runtimeType}"');
    }
...
class Promoted extends Event {
  const Promoted({
    required this.assetId,
    required this.systemTokenWeight,
  });

  factory Promoted._decode(_i1.Input input) {
    return Promoted(
      assetId: _i1.U32Codec.codec.decode(input),
...
class Demoted extends Event {
  const Demoted({required this.assetId});

  factory Demoted._decode(_i1.Input input) {
    return Demoted(assetId: _i1.U32Codec.codec.decode(input));
  }
  ...
  bool operator ==(Object other) =>
      ...
      other is Demoted && other.assetId == assetId;
...
class AssetSystemTokenWeightChanged extends Event {
  const AssetSystemTokenWeightChanged({
    required this.assetId,
    required this.from,
    required this.to,
  });

  factory AssetSystemTokenWeightChanged._decode(_i1.Input input) {
    return AssetSystemTokenWeightChanged(
      assetId: _i1.U32Codec.codec.decode(input),
      from: _i1.U128Codec.codec.decode(input),
      to: _i1.U128Codec.codec.decode(input),
    );
  }
  ...
  int _sizeHint() {
    int size = 1;
    size = size + _i1.U32Codec.codec.sizeHint(assetId);
    size = size + _i1.U128Codec.codec.sizeHint(from);
    size = size + _i1.U128Codec.codec.sizeHint(to);
    return size;
  }
  ...
  bool operator ==(Object other) =>
      ...
      other is AssetSystemTokenWeightChanged &&
          other.assetId == assetId &&
          other.from == from &&
          other.to == to;
