...
import '../BoundedBytes/bounded_bytes_9.dart' as _i3;
...
class PSPublicKey {
  ...
  factory PSPublicKey.decode(_i1.Input input) {
  ...
  /// BoundedBytes<T::MaxPSPublicKeySize>
  ...
  static const $PSPublicKeyCodec codec = $PSPublicKeyCodec();
...
class $PSPublicKeyCodec with _i1.Codec<PSPublicKey> {
  const $PSPublicKeyCodec();
  ...
  @override
  PSPublicKey decode(_i1.Input input) {
    return PSPublicKey(
