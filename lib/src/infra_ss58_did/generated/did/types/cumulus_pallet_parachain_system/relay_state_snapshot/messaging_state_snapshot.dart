...
import '../../parachain_primitives/primitives/id.dart' as _i5;
import '../../primitive_types/h256.dart' as _i2;
import '../../primitives/v6/abridged_hrmp_channel.dart' as _i6;
...
class MessagingStateSnapshot {
  ...
  final _i3.RelayDispatchQueueRemainingCapacity
      relayDispatchQueueRemainingCapacity;
  ...
  Map<String, dynamic> toJson() => {
        ...
        'relayDispatchQueueRemainingCapacity':
            relayDispatchQueueRemainingCapacity.toJson(),
  ...
  bool operator ==(Object other) =>
      ...
      other is MessagingStateSnapshot &&
          ...
          other.relayDispatchQueueRemainingCapacity ==
              relayDispatchQueueRemainingCapacity &&
          _i8.listsEqual(
...
class $MessagingStateSnapshotCodec with _i1.Codec<MessagingStateSnapshot> {
  ...
  MessagingStateSnapshot decode(_i1.Input input) {
    return MessagingStateSnapshot(
      ...
      relayDispatchQueueRemainingCapacity:
          _i3.RelayDispatchQueueRemainingCapacity.codec.decode(input),
      ingressChannels:
          const _i1.SequenceCodec<_i4.Tuple2<_i5.Id, _i6.AbridgedHrmpChannel>>(
              _i4.Tuple2Codec<_i5.Id, _i6.AbridgedHrmpChannel>(
        _i5.IdCodec(),
  ...
  int sizeHint(MessagingStateSnapshot obj) {
    ...
    size = size +
        _i3.RelayDispatchQueueRemainingCapacity.codec
            .sizeHint(obj.relayDispatchQueueRemainingCapacity);
    size = size +
        const _i1.SequenceCodec<_i4.Tuple2<_i5.Id, _i6.AbridgedHrmpChannel>>(
            _i4.Tuple2Codec<_i5.Id, _i6.AbridgedHrmpChannel>(
          _i5.IdCodec(),
