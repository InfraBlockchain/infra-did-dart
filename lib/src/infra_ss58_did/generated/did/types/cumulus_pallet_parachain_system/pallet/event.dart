...
import '../../sp_runtime/types/token/remote_asset_metadata.dart' as _i5;
...
class $Event {
  ...
  AssetForSystemTokenRequestsed assetForSystemTokenRequestsed(
      {required _i5.RemoteAssetMetadata requestedAsset}) {
    return AssetForSystemTokenRequestsed(requestedAsset: requestedAsset);
  }
}
...
class $EventCodec with _i1.Codec<Event> {
  ...
  Event decode(_i1.Input input) {
    ...
    switch (index) {
      ...
      case 7:
        return AssetForSystemTokenRequestsed._decode(input);
      default:
  ...
  void encodeTo(
    ...
    switch (value.runtimeType) {
      ...
      case UpwardMessageSent:
        ...
        break;
      case AssetForSystemTokenRequestsed:
        (value as AssetForSystemTokenRequestsed).encodeTo(output);
        break;
      default:
        throw Exception(
  ...
  int sizeHint(Event value) {
    switch (value.runtimeType) {
      ...
      case AssetForSystemTokenRequestsed:
        return (value as AssetForSystemTokenRequestsed)._sizeHint();
      default:
        throw Exception(
            'Event: Unsupported "$value" of type "${value.runtimeType}"');
    }
...
class ValidationFunctionApplied extends Event {
  ...
  bool operator ==(Object other) =>
      ...
      other is ValidationFunctionApplied &&
          other.relayChainBlockNum == relayChainBlockNum;
...
class UpwardMessageSent extends Event {
  ...
  factory UpwardMessageSent._decode(_i1.Input input) {
    return UpwardMessageSent(
        messageHash: const _i1.OptionCodec<List<int>>(_i1.U8ArrayCodec(32))
            .decode(input));
  }
...
class AssetForSystemTokenRequestsed extends Event {
  const AssetForSystemTokenRequestsed({required this.requestedAsset});

  factory AssetForSystemTokenRequestsed._decode(_i1.Input input) {
    return AssetForSystemTokenRequestsed(
        requestedAsset: _i5.RemoteAssetMetadata.codec.decode(input));
  }

  /// RemoteAssetMetadata
  final _i5.RemoteAssetMetadata requestedAsset;

  @override
  Map<String, Map<String, Map<String, dynamic>>> toJson() => {
        'AssetForSystemTokenRequestsed': {
          'requestedAsset': requestedAsset.toJson()
        }
      };

  int _sizeHint() {
    int size = 1;
    size = size + _i5.RemoteAssetMetadata.codec.sizeHint(requestedAsset);
    return size;
  }
  ...
  void encodeTo(_i1.Output output) {
    ...
    _i5.RemoteAssetMetadata.codec.encodeTo(
      requestedAsset,
      output,
    );
  }
  ...
  bool operator ==(Object other) =>
      ...
      other is AssetForSystemTokenRequestsed &&
          other.requestedAsset == requestedAsset;

  @override
  int get hashCode => requestedAsset.hashCode;
}
