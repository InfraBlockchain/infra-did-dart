...
import '../../primitives/v6/upgrade_go_ahead.dart' as _i4;
...
class $AncestorCodec with _i1.Codec<Ancestor> {
  ...
  void encodeTo(
    ...
    const _i1.OptionCodec<_i4.UpgradeGoAhead>(_i4.UpgradeGoAhead.codec)
        .encodeTo(
  ...
  Ancestor decode(_i1.Input input) {
    return Ancestor(
      ...
      paraHeadHash:
          const _i1.OptionCodec<_i3.H256>(_i3.H256Codec()).decode(input),
      consumedGoAheadSignal:
          const _i1.OptionCodec<_i4.UpgradeGoAhead>(_i4.UpgradeGoAhead.codec)
              .decode(input),
    );
  ...
  int sizeHint(Ancestor obj) {
    ...
    size = size +
        const _i1.OptionCodec<_i3.H256>(_i3.H256Codec())
            .sizeHint(obj.paraHeadHash);
    size = size +
        const _i1.OptionCodec<_i4.UpgradeGoAhead>(_i4.UpgradeGoAhead.codec)
            .sizeHint(obj.consumedGoAheadSignal);
    return size;
  }
}
