...
class RemoveVerifierRaw {
  const RemoveVerifierRaw({
    required this.authorizerId,
    required this.entityIds,
  });

  factory RemoveVerifierRaw.decode(_i1.Input input) {
  ...
  static const $RemoveVerifierRawCodec codec = $RemoveVerifierRawCodec();
...
class $RemoveVerifierRawCodec with _i1.Codec<RemoveVerifierRaw> {
  const $RemoveVerifierRawCodec();

  @override
  void encodeTo(
    RemoveVerifierRaw obj,
    _i1.Output output,
  ) {
  ...
  @override
  RemoveVerifierRaw decode(_i1.Input input) {
    return RemoveVerifierRaw(
  ...
  @override
  int sizeHint(RemoveVerifierRaw obj) {
    int size = 0;
